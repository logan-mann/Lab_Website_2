...
function loadStatsPage()
{
	...
	var wins = 0;
	var losses = 0;
	var numRows = stats_table.rows.length;
	var homeScore;
	var awayScore;
	for (var i = 2; i < numRows;i++)
	{
		var awayTeam = stats_table.rows[i].cells[1].innerHTML;
		homeScore = stats_table.rows[i].cells[2].innerHTML;
		homeScore = parseInt(homeScore);
		awayScore = stats_table.rows[i].cells[3].innerHTML;
		...
		{
			stats_table.rows[i].cells[4].innerHTML = awayTeam;
			losses++;
...
function switchPlayers(playerNum)
{
	...
	document.getElementById("p_yards").innerHTML = players[plyaerNum].pass_yards;
